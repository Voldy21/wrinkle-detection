...
for x, y, w, h in faces:
    ...
    corner_left_eye = cropped_img[y1+h1//2:y1+h1, x1+w1:x1+w1+12]
    ...
    # cv2.imshow("cropped", forehead_edges)
    cv2.waitKey(0)
    ...
    #     cv2.rectangle(blur, (nx, ny), (nx + nw, ny + nh), (0, 0, 0), -1)

    # # cv2.imshow("smile", blur)
    # cv2.waitKey(0)
